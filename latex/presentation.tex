...
\begin{frame}
 ...
 \begin{itemize}
  \item Similar to cuprates, which are best known for HTSC % structure wise, d-orbitals, layout 
  ...
  \item Realization of theoretical models: Spin models, 2D systems, Kitaev model,\dots % Kitaev model is exactly solvable, might be useful for quantum computing
 \end{itemize}
\end{frame}
...
\begin{frame}
 ...
 \begin{itemize}
  ...
  \item Effective models % and parameters
 \end{itemize}
\end{frame}
...
\begin{frame}
 ...
 \begin{frame}
 \framtitle{Brillouin zone}
 % =============================================================================================
 % Explain concept of discretized and periodic momenta in a crystal. 
 % =============================================================================================
 % Show dispersion for the models
 % =============================================================================================
\begin{center}
 \includegraphics[width=.4\textwidth]{../path}
\end{center}
\end{frame}
...
\begin{frame}
 ...
 \begin{itemize}
  ...
  \only<3>{  \begin{equation*}H = J \sum_{\langle i,j\rangle} \vec S_i \vec S_j  
   \: \:\phantom{
