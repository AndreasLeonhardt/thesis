...
The discovery of HTSC in cuprates 
...
\end{comment}
%Iridiates have been synthesized as early as , 
...
As a layered perovskite, Sr$_2$IrO$_4$ consists of single layers with a structure similar to CaTiO$_3$.
...
\section{Tight Binding Model} % in second quantization
