...
The main contribution is independent of momentum and frequency, and the variation due to higher order terms are of order $10^{-2}$ \todo{varify} compared to the total correction.
...
Singh\todo{nameref?} calculated the corrections given by diagrams corresponding to quantum fluctuations and found a value consistent with $\mathcal{Z}_c$.
...
% We found that the interaction is substantially lower in iridates than in cuprates. 
% w/o SOC we would have a metal for that U (e.g. in cuprates)
